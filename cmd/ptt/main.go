...
func main() {
	...
	tt, err := timetable.GenerateTimetable((time.Time)(startFlag), (time.Time)(endFlag), pauseFlag, timetable.SessionInfo{Duration: durationFlag, SessionLength: sessionLengthFlag})
	if err != nil {
